...
void writer33 (char *msg, int lck1,int lck2)
{
...
void reader44(char *msg, int sem1, int sem2)
{
...
void test1()
{
        ...
        rd1 = create(reader44, 2000, 30, "reader3", 2, "reader A", sem1,sem2);
        rd2 = create(reader4, 2000, 40, "reader3", 2, "reader B", sem2);
        rd3 = create(reader4, 2000, 50, "reader3", 2, "reader C", sem1);
...
void test3 ()
{
        ...
        wr1 = create(writer33, 2000, 30, "reader3", 3, "Writer A", lck1,lck2);
        wr2 = create(writer3, 2000, 40, "reader3", 2, "Writer B", lck2);
        wr3 = create(writer3, 2000, 50, "reader3", 2, "Writer C", lck1);
