...
struct	pentry	{
	...
	int	pwaitret;
	int 	locktype;		/* Process Holding Locktype     */
	int 	pltime;			/* Lock Wiating Time 		*/
	int 	hlocks[50];		/* The Locks being held 	*/ 
	int		pinh;			/* Priority for Inversion 	*/
	int 	lockid;			/* Indicating the lock for which it is waiting */
};
