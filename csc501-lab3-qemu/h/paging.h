...
#define TOTAL_STORES 16
#define CLEAN 1
#define DIRTY 0

#define VHEAP_PRIVATE 2
#define VIRT_SHARE 1

#define BSM_UNMAPPED	0
#define BSM_MAPPED	1

#define BSM_PRIVATE 0
#define BSM_SHARED 1
